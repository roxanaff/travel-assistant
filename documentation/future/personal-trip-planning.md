# Future Direction — Personal Trip Planning

## Trip setup

- Multiple destinations, structured by country and city/area, with destination-specific dates and notes.
- Destination search and validation.
- Number of travellers.
- Arrival time on the first trip day and departure time on the last trip day, shown in itinerary headings.
- Clear rules and scheduling hints for activities on arrival and departure days.
- A refined, final trip-type list and any additional types that prove useful.

## Itinerary

- Calendar view, explicit empty time slots, and short/expanded layouts for calendar use.
