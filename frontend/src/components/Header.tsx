...
export function Header() {
    ...
    const [dialog, setDialog] = useState<
        "change-password" | "delete-account" | null
    >(null);
            ...
            <div className="account-menu" ref={menuRef}>
                ...
                {isMenuOpen && (
                    <div className="account-dropdown" role="menu">
                        ...
                        <button
                            className="text-button account-delete-button"
                            type="button"
...
function DeleteAccountDialog({
    onClose,
    onSubmit,
}: DialogProps & { onSubmit: (password: string) => Promise<void> }) {
    ...
    return (
        <AccountDialog title="Delete account" onClose={onClose}>
            <form className="account-form" onSubmit={submit}>
                <p>
                    This permanently deletes your account, trips, and all trip
                    data. Enter your password to continue.
                </p>
                <label>
                    <span className="field-label field-label-required">
                        Password
...
function AccountDialog({
    ...
    onClose,
    children,
}: DialogProps & { title: string; children: React.ReactNode }) {
